...
def main():
    ...
    # File paths
    base_dir = r"C:\Users\admin\Desktop\sweta\MPS_syn_data_gen\singapore_foursquare_dataset\synthetic_data_v2\json_gen\output_syn_json"
    ...
    output_dir = os.path.join(base_dir, "postprocessing")
