...
with open('analysis_older_dataset/analysis_set4/codes/No_of_rootCat_C_top20/Clustering_Profiling/cluster_timewise_category.csv', 'w') as f:
...
print('Saved time-wise POI category mapping for each cluster to analysis_older_dataset/analysis_set4/codes/No_of_rootCat_C_top20/Clustering_Profiling/cluster_timewise_category.csv')
