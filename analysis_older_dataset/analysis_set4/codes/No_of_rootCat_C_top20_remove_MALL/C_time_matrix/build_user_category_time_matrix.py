...
checkins = pd.read_csv('analysis_older_dataset/analysis_set4/codes/No_of_rootCat_C_top20_remove_MALL/singapore_checkins_filtered_with_locations_coord.txt', sep='\t', names=cols)

print(checkins.head())

# Load POI to category mapping
place_cat = pd.read_csv('analysis_older_dataset/analysis_set4/codes/No_of_rootCat_C_top20_remove_MALL/sg_place_id_to_category.csv')
...
np.save('analysis_older_dataset/analysis_set4/codes/No_of_rootCat_C_top20_remove_MALL/C_time_matrix/user_category_time_matrices.npy', user_matrices)
with open('analysis_older_dataset/analysis_set4/codes/No_of_rootCat_C_top20_remove_MALL/C_time_matrix/user_category_labels.txt', 'w') as f:
