...
INPUT_JSON = os.path.join(BASE_DIR, "c5_JSON_Dataset_Gen_from_fsq_direct", "input_sampled_fsq_json", "input.json")
OUTPUT_JSON = os.path.join(BASE_DIR, "c5_JSON_Dataset_Gen_from_fsq_direct", "output_syn_json", "fsq_to_synthetic.json")
