...
BASE_DIR = os.path.dirname(SCRIPT_DIR)  # Go up one level from validation_graph/ to c5_JSON_Dataset_Gen_from_fsq_direct/

JSON_OUTPUT = os.path.join(BASE_DIR, "output_syn_json", "fsq_to_synthetic.json")
OUTPUT_DIR = os.path.join(SCRIPT_DIR, "user_poi_time_graphs")  # Store graphs in validation_graph/user_poi_time_graphs/
