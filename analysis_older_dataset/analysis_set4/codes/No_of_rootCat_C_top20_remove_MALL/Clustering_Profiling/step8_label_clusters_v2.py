...
import json
with open('analysis_older_dataset/analysis_set4/codes/No_of_rootCat_C_top20_remove_MALL/Clustering_Profiling/final_cluster_profiles_v2.json', 'w') as f:
    json.dump(output, f, indent=2)
print('Saved improved cluster profiles to analysis_older_dataset/analysis_set4/codes/No_of_rootCat_C_top20_remove_MALL/Clustering_Profiling/final_cluster_profiles_v2.json')
