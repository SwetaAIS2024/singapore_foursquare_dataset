...
INPUT_FILE = "C:\\Users\\admin\\Desktop\\sweta\\MPS_syn_data_gen\\singapore_foursquare_dataset\\Code_Freeze_Changes\\c5_JSON_Dataset_Generation\\c0_scripts\\LLM_method\\older\\per_cluster_insights\\all_clusters_summary.csv"
OUTPUT_FILE = "C:\\Users\\admin\\Desktop\\sweta\\MPS_syn_data_gen\\singapore_foursquare_dataset\\Code_Freeze_Changes\\c5_JSON_Dataset_Generation\\c0_scripts\\LLM_method\\older\\per_cluster_insights\\all_clusters_summary_with_area.csv"
...
def append_planning_area(input_file: str, output_file: str):
    ...
    for index, row in df.iterrows():
        lat = row["mean_lat"]  # Replace with the actual column name for latitude
        lon = row["mean_lon"]  # Replace with the actual column name for longitude
