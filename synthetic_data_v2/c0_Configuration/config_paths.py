...
CHECKINS_PATH_CSV = os.path.join(BASE_DIR, "./c1_Data_Collection_and_Processing/input_data/FSQ_SG_2013_Checkins.csv")
POI_COORDINATES_CSV = os.path.join(BASE_DIR, "./c1_Data_Collection_and_Processing/input_data/FSQ_SG_2013_POI.csv")
