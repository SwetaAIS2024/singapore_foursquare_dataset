...
JSON_OUTPUT_DIR = os.path.join(BASE_DIR, "./c4_JSON_Dataset_Generation/c1_outputs")
# each poi has a mapping id 
POI_UNIQUE_ID_MAPPING = os.path.join(BASE_DIR, "./c4_JSON_Dataset_Generation/c0_scripts/LLM_method/older/mapping.csv")

# DATA PROCESSING PIPELINE BEFORE GIVING TO MODEL PROMPT
CLUSTER_SUMMARY_DIR = os.path.join(BASE_DIR, "c4_JSON_Dataset_Generation/older/per_cluster_insights")
CLUSTER_SUMMARY = os.path.join(BASE_DIR, "c4_JSON_Dataset_Generation/c0_scripts/LLM_method/older/per_cluster_insights/all_clusters_summary_with_area.csv")
...
FINAL_CHECKIN_FILE_TO_LLM = os.path.join(BASE_DIR, "c4_JSON_Dataset_Generation/input_dataset/final_checkin_file.json")
FINAL_JSON_INPUT = os.path.join(BASE_DIR, "c4_JSON_Dataset_Generation/input_dataset/final_checkin_file.json")
