...
plt.tight_layout()
plt.savefig('analysis_older_dataset/analysis_set4/codes/No_of_rootCat_C_180/Clustering_Profiling/user_clusters_pca123_scatter.png')
plt.close()
...
plt.tight_layout()
plt.savefig('analysis_older_dataset/analysis_set4/codes/No_of_rootCat_C_180/Clustering_Profiling/user_clusters_pca123_centroids.png')
plt.close()
