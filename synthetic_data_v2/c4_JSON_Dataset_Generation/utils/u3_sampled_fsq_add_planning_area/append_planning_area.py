...
from c0_Configuration.config_paths import SAMPLED_FSQ, SAMPLED_FSQ_PLANNING_AREA, PLANNING_CACHE, SUBZONE_CACHE

# Local cache paths
INPUT_FILE = SAMPLED_FSQ
...
def append_planning_area(input_file: str, output_file: str, gdf):
    ...
    print(f"Coordinate bounds: lat=[{df['lat'].min():.6f}, {df['lat'].max():.6f}], "
