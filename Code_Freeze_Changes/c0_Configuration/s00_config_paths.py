...
REAL_USERS_NPY_PATH = os.path.join(BASE_DIR, "./c3_Synthetic_FSQ_Samples_SDV/c1_sampling_outputs/real_users.npy")
POST_SAMPLING_ANALYSIS_OUTPUT_DIR = os.path.join(BASE_DIR, "./c3_Synthetic_FSQ_Samples_SDV/c3_output_analysis/post_sampling_analysis_outputs")
DIMRED_MODEL_PATH = os.path.join(BASE_DIR, "./c2_Clustering_and_Analysis/c1_output/clustering_kmeans.pkl")

# Individual cluster analysis paths
CLUSTER_DISTRIBUTION_SUMMARY_PATH = os.path.join(BASE_DIR, "./c2_Clustering_and_Analysis/c3_individual_cluster_analysis/cluster_analysis/kmeans/cluster_summary.csv")
CLUSTER_DISTRIBUTION_PARAMS_PATH = os.path.join(BASE_DIR, "./c2_Clustering_and_Analysis/c3_individual_cluster_analysis/cluster_analysis/kmeans")


# Paths updated for the sampling script 
ORIGINAL_DATA_PATH = CHECKINS_PATH
CLUSTER_LABELS_PATH = os.path.join(BASE_DIR, "./c2_Clustering_and_Analysis/c1_output/kmeans/user_cluster_labels_user_to_cluster.txt")
OUTPUT_SAMPLED_FSQ_PATH = os.path.join(BASE_DIR,"./c3_Synthetic_FSQ_Samples_SDV/c0_sampling_scripts/sampled_dataset_after_clustering/sampled_FSQ_dataset_after_clustering.txt")
...
#sdv 
SDV_OUTPUT_DIR = os.path.join(BASE_DIR,"./c3_Synthetic_FSQ_Samples_SDV/c2_synthesis_outputs")
...
SDV_POST_SYNTHESIS_ANALYSIS_OUTPUT_DIR = os.path.join(BASE_DIR,"./c3_Synthetic_FSQ_Samples_SDV/c3_output_analysis/analysis_SDV_from_cluster_samples")

# multi-table seq synthesis
MULTI_TABLE_SEQ_SYN_ANALYSIS_OUTPUT_DIR = os.path.join(BASE_DIR,"./c3_Synthetic_FSQ_Samples_SDV/c4_multi_table_seq")
