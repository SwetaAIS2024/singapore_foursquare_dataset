...
from c0_Configuration.config_paths import CLUSTER_SUMMARY, CLUSTER_SUMMARY_WITH_PLANNING_AREA

# Local cache paths
PLANNING_CACHE = "./planning_area.geojson"
SUBZONE_CACHE = "./subzone.geojson"
INPUT_FILE = CLUSTER_SUMMARY
OUTPUT_FILE = CLUSTER_SUMMARY_WITH_PLANNING_AREA
