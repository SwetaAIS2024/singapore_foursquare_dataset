...
# File paths
org_path = 'syn_org_eval/original_checkins.txt'
syn_path = 'syn_org_eval/synthetic_checkins.txt'
...
org_user_counts.to_csv('syn_org_eval/org_user_checkin_counts.csv')
syn_user_counts.to_csv('syn_org_eval/syn_user_checkin_counts.csv')
org_poi_counts.to_csv('syn_org_eval/org_poi_checkin_counts.csv')
syn_poi_counts.to_csv('syn_org_eval/syn_poi_checkin_counts.csv')
