...
data = np.load('analysis_older_dataset/analysis_set4/codes/No_of_rootCat_C_top20/C_time_matrix/user_category_time_matrices.npy', allow_pickle=True).item()
...
# Save embeddings
pd.DataFrame(user_embeds, index=user_ids).to_csv('analysis_older_dataset/analysis_set4/codes/No_of_rootCat_C_top20/Dimension_reduction_graph_construction/embeddings/user_pca_embeddings.csv')
...
os.makedirs('analysis_older_dataset/analysis_set4/codes/No_of_rootCat_C_top20/Dimension_reduction_graph_construction/graph', exist_ok=True)
with open('analysis_older_dataset/analysis_set4/codes/No_of_rootCat_C_top20/Dimension_reduction_graph_construction/graph/user_similarity_knn_graph.gpickle', 'wb') as f:
    pickle.dump(G, f)
...
plt.axis('off')
plt.tight_layout()
plt.savefig('analysis_older_dataset/analysis_set4/codes/No_of_rootCat_C_top20/Dimension_reduction_graph_construction/graph/user_similarity_knn_subgraph_2d.png')
plt.show()
...
plt.tight_layout()
plt.savefig('analysis_older_dataset/analysis_set4/codes/No_of_rootCat_C_top20/Dimension_reduction_graph_construction/graph/user_similarity_knn_subgraph_3d.png')
plt.show()
