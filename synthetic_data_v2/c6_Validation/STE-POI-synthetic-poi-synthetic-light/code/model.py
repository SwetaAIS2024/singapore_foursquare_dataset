...
class UserTower(nn.Module):
    def __init__(self, poi_reps, user_cat_dims, user_cont_dim, history_len, embed_dim, poi_cat_class, hidden_dim, hist_dim, dropout=0.1, user_mode='feat'):
    ...
    def forward(self, user_cat, user_cont, trans_history, view_history, review_history, time, loc):
        ...
        if self.user_mode != 'feat':
            ...
            user_feat = torch.cat([hist_rep, time_rep, loc_rep], dim=1)
...
class HistoryEncoder(nn.Module):
    def __init__(self, embed_dim, max_len=50, num_heads=2, hidden_size=64, num_layers=1, dropout=0.1):
        super().__init__()
...
class RecommendationModel(nn.Module):
    def __init__(self, 
        ...
        self.user_tower = UserTower(self.poi_reps, user_cat_dims, user_cont_dim, history_len, embed_dim, self.poi_cat_class, hist_dim, hist_dim)
