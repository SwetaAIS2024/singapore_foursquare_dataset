...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_path", type=str, default="../saved_model/model_ckpt_cat.pth", help="Model path")
    ...
    _, _, test_data, _ = process_user_histories(user_data, args.train_ratio, args.val_ratio)
    ...
    val_metric = evaluate_nxt_cat(model, test_loader, args.device, idx2cat, mode='test')
