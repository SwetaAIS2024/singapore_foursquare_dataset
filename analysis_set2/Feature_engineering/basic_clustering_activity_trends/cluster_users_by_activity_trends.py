...
N_CLUSTERS = 15  # Change as needed
...
print(f"Cluster assignments written to {OUTPUT_CSV}")
...
plt.title('User Clusters by Activity Trends (PCA projection)')
plt.legend()
plt.tight_layout()
plot_path = os.path.join(os.path.dirname(OUTPUT_CSV), 'user_clusters_pca_plot.png')
